...
Define the unified gounslop plugin that registers a single plugin module with golangci-lint, handles analyzer enable/disable via settings, and manages per-analyzer configuration. (TBD)
